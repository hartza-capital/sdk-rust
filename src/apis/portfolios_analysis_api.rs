...
/// struct for typed errors of method [`options_portfolios_analysis`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OptionsPortfoliosAnalysisError {
...
pub async fn options_portfolios_analysis(configuration: &configuration::Configuration, ) -> Result<(), Error<OptionsPortfoliosAnalysisError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<OptionsPortfoliosAnalysisError> = serde_json::from_str(&content).ok();
