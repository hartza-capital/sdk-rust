...
/// struct for typed errors of method [`options_search`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OptionsSearchError {
...
pub async fn options_search(configuration: &configuration::Configuration, ) -> Result<(), Error<OptionsSearchError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<OptionsSearchError> = serde_json::from_str(&content).ok();
