...
pub struct FilterReport200ResponseAllocation {
    ...
    pub orders: Option<std::collections::HashMap<String, models::FilterReport200ResponseAllocationOrdersValue>>,
    #[serde(rename = "count", skip_serializing_if = "Option::is_none")]
    pub count: Option<i32>,
}

impl FilterReport200ResponseAllocation {
    pub fn new() -> FilterReport200ResponseAllocation {
