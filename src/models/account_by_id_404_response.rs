...
/// AccountById404Response : Server can not find the requested resource
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AccountById404Response {
...
impl AccountById404Response {
    /// Server can not find the requested resource
    pub fn new() -> AccountById404Response {
        AccountById404Response {
            code: None,
            reason: None,
            message: None,
            metadata: None,
