...
/// Orders500Response : Server encountered an unexpected condition that prevented it from fulfilling the request
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct Orders500Response {
...
impl Orders500Response {
    /// Server encountered an unexpected condition that prevented it from fulfilling the request
    pub fn new() -> Orders500Response {
        Orders500Response {
            code: None,
            reason: None,
            message: None,
