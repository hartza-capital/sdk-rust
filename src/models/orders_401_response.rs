...
/// Orders401Response : Request could not be completed due to a conflict with the current state of the resource
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct Orders401Response {
