...
pub struct CountryByTicker200ResponseIndicatorsValue {
...
impl CountryByTicker200ResponseIndicatorsValue {
    pub fn new() -> CountryByTicker200ResponseIndicatorsValue {
        CountryByTicker200ResponseIndicatorsValue {
            name: None,
            events: None,
        }
    }
