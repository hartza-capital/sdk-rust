...
pub struct SearchQuotesInstrumentsStrategy200Response {
    /// Data is the list of strategies.
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::V1StrategiesQuoteResponse>>,
    /// Total is the total number of results.
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl SearchQuotesInstrumentsStrategy200Response {
    pub fn new() -> SearchQuotesInstrumentsStrategy200Response {
        SearchQuotesInstrumentsStrategy200Response {
            data: None,
            total: None,
        }
    }
