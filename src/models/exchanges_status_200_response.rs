...
pub struct ExchangesStatus200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<std::collections::HashMap<String, std::collections::HashMap<String, models::V1ExchangesStatusResult>>>,
    /// Total is the total number of results.
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl ExchangesStatus200Response {
    pub fn new() -> ExchangesStatus200Response {
