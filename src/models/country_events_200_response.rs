...
pub struct CountryEvents200Response {
    /// Data is the list of events.
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::CountryEvents200ResponseDataInner>>,
    /// Total is the total number of results.
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl CountryEvents200Response {
    pub fn new() -> CountryEvents200Response {
        CountryEvents200Response {
            data: None,
            total: None,
        }
    }
