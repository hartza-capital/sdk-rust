...
pub struct SearchDividends200Response {
    /// Data is a list of dividends for the security.
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::V1DividendResponse>>,
    /// Total is the total number of results.
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl SearchDividends200Response {
    pub fn new() -> SearchDividends200Response {
        SearchDividends200Response {
            data: None,
            total: None,
        }
    }
