...
/// SearchNews200Response : NewsSearchResponse is used to specify the response for the NewsSearch API.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SearchNews200Response {
    /// Data is a list of instruments.
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::SearchNews200ResponseDataInner>>,
...
impl SearchNews200Response {
    /// NewsSearchResponse is used to specify the response for the NewsSearch API.
