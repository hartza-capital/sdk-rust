...
pub struct CountryIndicatorsEventsByTicker200ResponseDataInner {
    /// ID is the unique identifier for the event.
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    /// Ticker is the unique identifier for the event.
    ...
    /// CreatedAt is the creation date of the event.
    #[serde(rename = "created_at", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<i64>,
}

impl CountryIndicatorsEventsByTicker200ResponseDataInner {
    pub fn new() -> CountryIndicatorsEventsByTicker200ResponseDataInner {
