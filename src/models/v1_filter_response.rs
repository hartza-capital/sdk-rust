...
/// V1FilterResponse : GetFilterResponse is used to specify the response for the GetFilter API.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct V1FilterResponse {
