...
pub struct Filters200Response {
    /// Data is the list of filters.
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::Filters200ResponseDataInner>>,
...
impl Filters200Response {
    pub fn new() -> Filters200Response {
        Filters200Response {
            data: None,
            items: None,
            total_items: None,
