...
/// V1ExchangeBulkResponse : Exchanges is the list of exchanges used in the country.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct V1ExchangeBulkResponse {
...
impl V1ExchangeBulkResponse {
    /// Exchanges is the list of exchanges used in the country.
    pub fn new() -> V1ExchangeBulkResponse {
