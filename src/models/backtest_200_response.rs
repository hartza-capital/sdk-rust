...
pub struct Backtest200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::Backtest200ResponseDataInner>>,
    #[serde(rename = "stats", skip_serializing_if = "Option::is_none")]
    pub stats: Option<Box<models::Backtest200ResponseStats>>,
    /// Total is the total number of results.
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl Backtest200Response {
    pub fn new() -> Backtest200Response {
        Backtest200Response {
            data: None,
            stats: None,
            total: None,
