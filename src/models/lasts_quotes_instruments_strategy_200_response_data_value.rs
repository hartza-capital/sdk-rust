...
pub struct LastsQuotesInstrumentsStrategy200ResponseDataValue {
...
impl LastsQuotesInstrumentsStrategy200ResponseDataValue {
    pub fn new() -> LastsQuotesInstrumentsStrategy200ResponseDataValue {
        LastsQuotesInstrumentsStrategy200ResponseDataValue {
            status: None,
            open: None,
            close: None,
            created_at: None,
