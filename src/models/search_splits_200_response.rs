...
pub struct SearchSplits200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::V1SplitResponse>>,
    /// Total is the total number of results.
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl SearchSplits200Response {
    pub fn new() -> SearchSplits200Response {
        SearchSplits200Response {
            data: None,
            total: None,
        }
    }
