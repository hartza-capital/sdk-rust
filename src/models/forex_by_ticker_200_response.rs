...
impl ForexByTicker200Response {
    pub fn new() -> ForexByTicker200Response {
        ForexByTicker200Response {
            ticker: None,
            quote: None,
            stats: None,
            from: None,
