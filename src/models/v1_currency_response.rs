...
/// V1CurrencyResponse : v1GetCurrencyResponse is used to show the response of the currencies.
...
impl V1CurrencyResponse {
    /// v1GetCurrencyResponse is used to show the response of the currencies.
