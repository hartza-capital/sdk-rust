...
pub struct Portfolios200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<std::collections::HashMap<String, models::V1ListPortfoliosResponseResult>>,
    /// Total is the number of results.
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl Portfolios200Response {
    pub fn new() -> Portfolios200Response {
