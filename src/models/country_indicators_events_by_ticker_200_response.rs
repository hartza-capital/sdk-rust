...
pub struct CountryIndicatorsEventsByTicker200Response {
    /// Data is the list of events.
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::CountryIndicatorsEventsByTicker200ResponseDataInner>>,
    /// Total is the total number of results.
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl CountryIndicatorsEventsByTicker200Response {
    pub fn new() -> CountryIndicatorsEventsByTicker200Response {
