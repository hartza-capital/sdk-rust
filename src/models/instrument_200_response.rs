...
/// Instrument200Response : GetInstrumentResponse is used to specify the response for the GetInstrument API.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct Instrument200Response {
    ...
    pub stats: Option<Box<models::Instrument200ResponseStats>>,
    ...
    pub shares: Option<Box<models::Instrument200ResponseShares>>,
    #[serde(rename = "tax", skip_serializing_if = "Option::is_none")]
    pub tax: Option<Box<models::Instrument200ResponseTax>>,
    #[serde(rename = "contact", skip_serializing_if = "Option::is_none")]
    pub contact: Option<Box<models::Instrument200ResponseContact>>,
    #[serde(rename = "address", skip_serializing_if = "Option::is_none")]
    pub address: Option<Box<models::Instrument200ResponseAddress>>,
