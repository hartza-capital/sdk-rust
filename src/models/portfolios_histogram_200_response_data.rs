...
pub struct PortfoliosHistogram200ResponseData {
    /// Changes is a list of changes for the histogram.
    #[serde(rename = "performance", skip_serializing_if = "Option::is_none")]
    pub performance: Option<Vec<models::PortfoliosHistogram200ResponseDataPerformanceInner>>,
...
impl PortfoliosHistogram200ResponseData {
    pub fn new() -> PortfoliosHistogram200ResponseData {
        PortfoliosHistogram200ResponseData {
            performance: None,
            distribution: None,
        }
    }
